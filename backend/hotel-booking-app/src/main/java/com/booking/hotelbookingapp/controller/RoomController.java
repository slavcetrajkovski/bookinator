...
import com.booking.hotelbookingapp.exception.PhotoRetrievalException;
...
public class RoomController {
    ...
    public ResponseEntity<List<RoomResponse>> getAvailableRooms(
            @RequestParam("checkInDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)String checkInDateString,
            @RequestParam("checkOutDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)String checkOutDateString,
            @RequestParam("roomType") String roomType) throws SQLException {

        LocalDate checkInDate = LocalDate.parse(checkInDateString.trim());
        LocalDate checkOutDate = LocalDate.parse(checkOutDateString.trim());
